...
class PDFFormFiller:
    def __init__(self, db_employee_json_object):
        ...
        self.pda1_form_input_path = os.path.expanduser(
            "~/office_automator_1/office_automator_1/admin_automator/zentak_legal_automator/pda1_filler_service/pdf_forms/pda1_form.pdf")
        self.pda1_form_output_path = os.path.expanduser(
            "~office_automator_1/office_automator_1/admin_automator/zentak_legal_automator/pda1_filler_service/pdf_forms/filled_form.pdf")
