...
def generate_pdf(request, id_employee, id_employee_agreement):
    if request.method == "POST":
        try:
            ...
            return FileResponse(open("/Users/robertsoroka/PycharmProjects/office_automator_1/admin_automator/zentak_legal_automator/pda1_filler_service/pdf_forms/filled_form.pdf", 'rb'), as_attachment=True, filename="Employee_Details.pdf")
